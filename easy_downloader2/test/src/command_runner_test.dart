...
void main() {
  group('EasyDownloaderCommandRunner', () {
    late PubUpdater pubUpdater;
    late Logger logger;
    late ProcessResult processResult;
    late EasyDownloaderCommandRunner commandRunner;
    ...
    setUp(() {
      ...
      commandRunner = EasyDownloaderCommandRunner(
        logger: logger,
    ...
    test('can be instantiated without an explicit analytics/logger instance',
        () {
      final commandRunner = EasyDownloaderCommandRunner();
