...
class MultiTasksDownload extends StatefulWidget {
  const MultiTasksDownload({Key? key}) : super(key: key);

  @override
  State<MultiTasksDownload> createState() => _MultiTasksDownloadState();
}

class _MultiTasksDownloadState extends State<MultiTasksDownload> {
