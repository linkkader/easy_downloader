...
extension EasyDownloaderExt on EasyDownloader{
  Future initFlutter(
    ...
    await EasyDownloader().init(isar: isar, localeStoragePath: localeStoragePath);
    if (allowNotification){
      assert(defaultIconAndroid != null || androidInitializationSettings != null, 'defaultIconAndroid or androidInitializationSettings must be not null');
